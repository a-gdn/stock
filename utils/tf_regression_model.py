...
def create_tf_model(**kwargs):
    ...
    quantile = kwargs.get('cumulated_probs_target')
...
def load_tf_model(df_data, hyperparams):
    df_input, df_output = get_dfs_input_output(df_data, cfg.output_regression)
