...
search_space = {
    ...
    'target_future_days': hp.randint('target_future_days', 1, 90), #hp.randint('target_future_days', 1, 60), #1, 60
    ...
    'cumulated_probs_target': hp.uniform('cumulated_probs_target', 0.1, 1),
    'thresholds': hp.choice('thresholds', [[1], [1.005], [1.01], [1.015], [1.02], [1.025], [1.03], [1.035], [1.04], [1.05],
                                           [1.06], [1.08], [1.10], [1.12], [1.15], [1.20], [1.25], [1.30], [1.35], [1.40],
                                           [1.45], [1.5], [1.6], [1.7], [1.8], [2], [2.25], [2.5], [3], [3.5], [4]]),
